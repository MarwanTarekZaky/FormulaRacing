...
{
    /// <inheritdoc />
    public partial class HomePageContentCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaceParagraph = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BannerText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageParagraph = table.Column<string>(type: "nvarchar(max)", nullable: false),
